...
declare const StyledImage: import("@tamagui/core").TamaguiComponent<import("@tamagui/core").GetFinalProps<import("react-native").ImageProps & Omit<StackProps, keyof import("react-native").ImageProps>, import("react-native").ImageProps & Omit<StackProps, keyof import("react-native").ImageProps> & {}>, RNImage, import("react-native").ImageProps & Omit<StackProps, keyof import("react-native").ImageProps>, import("react-native").ImageProps & Omit<StackProps, keyof import("react-native").ImageProps>, {}, {
    prototype: RNImage;
